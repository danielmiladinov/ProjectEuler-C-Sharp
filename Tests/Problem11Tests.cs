...
namespace Tests {
    ...
    class Problem11Tests {
        ...
        [Test]
        public void ShouldProduceTheCorrectMaxProductOfFourAdjacentNumbers () {
            var grid = new int[][] {
            ...
            var largestProduct = problem.getLargestProductIn(grid);
            Assert.AreEqual(70600674, largestProduct);
        }
    }
}
